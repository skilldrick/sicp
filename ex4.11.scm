...
(define (alt-make-frame variables values)
  (if (null? variables)
    '()
    (let ((pair (cons (car variables) (car values))))
      (cons pair (alt-make-frame (cdr variables) (cdr values))))))

(define (alt-frame-variables frame)
  (if (null? frame)
    '()
    (cons (caar frame) (alt-frame-variables (cdr frame)))))

(define (alt-frame-values frame)
  (if (null? frame)
    '()
    (cons (cdar frame) (alt-frame-values (cdr frame)))))
